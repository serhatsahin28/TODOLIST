...
if (isset($_POST['password']) && isset($_POST['username'])) {
  ...
  $user2 = mysqli_query($connect, $user);
  foreach ($user2 as $u) {
    if ($u['username'] != strtoupper($username)) {
      $query = "INSERT INTO user (username, password) VALUES ('" . strtoupper($username) . "','" . strtoupper($password) . "')";
      ...
      $error = '!!Bu isim de bir kullanıcı zaten var.Lütfen başka bir kullanıcı adı seçin!!';
    }
  }
}
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="pages-login.php" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">TODOLİST</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <br>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Zaten hesabınız var mı?<a href="pages-login.php">Giriş Yap</a></p>
                    </div>
                  </form>
